<?php
      ...
      include("connect.php");
      $reponse = $con->query("SELECT * FROM products where days in ('Monday', 'Saturday','Friday') limit 3");
...
<body>
          ...
          <div class="wrapper">
                ...
                <section class="content">
                              <h1 class=content__title>Top Foods</h1>
                <?php
            ...
            ?>
                ...
                <section id="about" class="wrapper__about about" >
                         ...
                         echo card("chef3 chef" ,"../img/Capture.PNG","Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum, possimus vero? Modi, ipsum? Ea quae nulla ratione vitae impedit iste debitis, enim, ipsum accusantium, vero sapiente dolorum consectetur.");
